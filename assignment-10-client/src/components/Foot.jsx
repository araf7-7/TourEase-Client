        ...
        <div>
            <div>
                <footer className="px-4 divide-y dark:bg-gray-100 dark:text-gray-800">
                        ...
                        <div className="lg:w-1/3">
                            <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                                <div className="flex items-center justify-center w-16 h-16 rounded-full ">
                                    <img src="https://i.ibb.co/BBq1HZ7/Purple-and-Blue-Grdient-Simple-Minimalist-Elegant-Website-Logo.png" alt="" />
                                </div>
                                <span className="self-center text-2xl font-semibold">TourEase</span>
                            </a>
                        </div>
                        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                            <div className="space-y-3">
                                ...
                                <ul className="space-y-1">
                                    ...
                                    <li>
                                        <a rel="noopener noreferrer" href="#">Booking</a>
                                    </li>
                                    <li>
                            ...
                            <div className="space-y-3">
                                <h3 className="uppercase dark:text-gray-900">Login</h3>
                                <ul className="space-y-1">
                                    <li>
                    ...
                    <div className="py-6 text-sm text-center dark:text-gray-600">© 1999 Company Co. All rights reserved.</div>
                </footer>
            </div>
        </div>
    );
